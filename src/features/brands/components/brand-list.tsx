              ...
              <table className="w-full text-left text-xs border-collapse min-w-[900px]">
                <thead>
                  <tr className="border-b border-border bg-muted/30 text-muted-foreground">
                    <th className="py-2.5 px-4 font-medium w-[220px] min-w-[180px]">Brand & Kode</th>
                    <th className="py-2.5 px-4 font-medium w-[200px] min-w-[160px]">Klien Pemilik</th>
                    <th className="py-2.5 px-4 font-medium min-w-[200px]">Deskripsi</th>
                    <th className="py-2.5 px-4 font-medium text-center w-[110px] min-w-[100px] whitespace-nowrap">Project Aktif</th>
                    <th className="py-2.5 px-4 font-medium w-[140px] min-w-[120px] whitespace-nowrap">Dibuat</th>
                    <th className="py-2.5 px-4 font-medium text-right w-[100px] min-w-[90px] whitespace-nowrap">Aksi</th>
                  </tr>
                </thead>
              <tbody className="divide-y divide-border/60">
                {brands.map((brand) => (
                  <tr key={brand.id} className="hover:bg-accent/30 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="inline-flex items-center rounded bg-muted/80 px-1.5 py-0.5 font-mono text-[10px] font-semibold text-foreground border border-border">
                          {brand.code}
                        </span>
                      </div>
                    </td>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs border-t border-border/60 pt-2 text-muted-foreground">
                  <div>
                    ...
                    <Link
                      href={`/clients/${brand.client_id}`}
                      className="hover:underline text-foreground truncate block"
                    >
                      {brand.client_name}
                    </Link>
                  </div>
                  <div>
                    ...
                    <span>{brand.projects_count ?? 0} Project</span>
                  </div>
                </div>
