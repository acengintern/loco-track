        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full rounded-md border border-input bg-background pl-9 pr-3 py-1.5 text-xs placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              <SelectTrigger id="qc-type-filter" className="h-8 text-xs min-w-36" aria-label="Filter Tipe Disiplin">
            ...
            >
              <SelectTrigger id="qc-round-filter" className="h-8 text-xs min-w-36" aria-label="Filter Putaran Revisi">
            ...
            >
              <SelectTrigger id="qc-priority-filter" className="h-8 text-xs min-w-32" aria-label="Filter Prioritas">
            ...
            >
              <SelectTrigger id="qc-sort-filter" className="h-8 text-xs min-w-44" aria-label="Urutkan Berdasarkan">
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[1080px]">
                <thead>
                  <tr className="border-b border-border bg-muted/30 text-muted-foreground font-medium">
                    <th className="px-4 py-3 w-[260px] min-w-[220px]">Tugas</th>
                    <th className="px-4 py-3 w-[180px] min-w-[150px]">Proyek</th>
                    <th className="px-4 py-3 w-[130px] min-w-[120px] whitespace-nowrap">Tipe</th>
                    <th className="px-4 py-3 w-[160px] min-w-[140px] whitespace-nowrap">PIC</th>
                    <th className="px-4 py-3 w-[130px] min-w-[110px] whitespace-nowrap">Versi & Ronde</th>
                    <th className="px-4 py-3 w-[140px] min-w-[130px] whitespace-nowrap">Waktu Kirim</th>
                    <th className="px-4 py-3 w-[140px] min-w-[130px] whitespace-nowrap">Deadline</th>
                    <th className="px-4 py-3 w-[120px] min-w-[110px] text-right whitespace-nowrap">Aksi</th>
                  </tr>
                </thead>
                  ...
                  {filteredItems.map((item) => (
                    <tr key={item.task_id} className="hover:bg-muted/20 transition-colors">
                      ...
                      <td className="px-4 py-3 max-w-[240px]">
                        <div className="font-semibold text-foreground truncate" title={item.task_title}>
                          {item.task_title}
                        </div>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        ...
                        <div className="text-[11px] text-muted-foreground truncate max-w-[140px]" title={item.project_name}>
                          {item.project_name}
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex flex-col items-start gap-1">
                          {item.latest_file ? (
                            <div className="inline-flex items-center gap-1 rounded bg-muted/60 px-1.5 py-0.5 font-mono text-[11px] font-semibold text-foreground">
                          ...
                          {item.has_prior_revisions ? (
                            <span className="inline-flex items-center gap-1 rounded bg-amber-500/10 text-amber-700 dark:text-amber-400 px-1.5 py-0.5 text-[10px] font-medium border border-amber-500/20">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-md bg-primary px-2.5 py-1 text-xs font-medium text-primary-foreground hover:bg-primary/90 transition-colors focus:outline-none focus:ring-1 focus:ring-ring"
                        >
